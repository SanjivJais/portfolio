...
export const Contact = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-8 mt-48 mb-48'>
            <h2 className='heading_grad text-4xl font-bold'>get in touch</h2>
            ...
            <div className="flex flex-col gap-4 items-center mt-3">
                <h3 className='fancy_grad_text text-xl'>Email me on</h3>
            ...
            <div className="flex flex-col gap-4 items-center mt-3">
                <h3 className='fancy_grad_text text-xl'>OR, DM me on</h3>
