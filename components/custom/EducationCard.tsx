        ...
        <div>
            <div className={`flex flex-col gap-2 text-white-100 p-10 w-full ${DATA.education.length - 1 !== educationDetails.idx ? 'border-b-2 border-card' : ''}`}>
                <div className="flex max-md:flex-col max-md:gap-2 justify-between md:items-center">
                    ...
                    <h3 className="text-white md:text-xl text-base font-bold max-w-[80%]">{educationDetails.title}</h3>
                ...
                <div className="flex gap-x-4 gap-y-2 flex-wrap items-center md:text-base text-sm">
